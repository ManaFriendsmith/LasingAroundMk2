...
local function get_prototype(name)
    local possibilities = { "item", "fluid", "ammo", "capsule", "gun", "item-with-entity-data", "item-with-label",
...
local function make_laser_recipe_icon(recipe, position, is_space)
    ...
    table.insert(starting_icon, {
        icon = is_space and "__space-exploration-graphics__/graphics/icons/astronomic/planet-orbit.png" or
            "__LasingAroundMk2__/graphics/icons/laser-modifier.png",
        icon_size = 64,
        scale = 0.25,
