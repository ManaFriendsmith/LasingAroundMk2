...
local lasermill = {
    ...
    circuit_connector = circuit_connector_definitions.create_vector(
        ...
        {
            { variation = 26, main_offset = util.by_pixel(24, 32), shadow_offset = util.by_pixel(19, 31), show_shadow = true },
            { variation = 26, main_offset = util.by_pixel(24, 32), shadow_offset = util.by_pixel(19, 31), show_shadow = true },
            { variation = 26, main_offset = util.by_pixel(24, 32), shadow_offset = util.by_pixel(19, 31), show_shadow = true },
            { variation = 26, main_offset = util.by_pixel(24, 32), shadow_offset = util.by_pixel(19, 31), show_shadow = true }
        }
    ...
    vehicle_impact_sound = util.table.deepcopy(data.raw["assembling-machine"]["assembling-machine-3"]
